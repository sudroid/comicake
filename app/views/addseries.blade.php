		...
		{{ Form::open(array('route'=>'content.series.store', 'id'=>'new_content', 'files'=>true, 'class'=>'form-horizontal')) }}
			...
			<div class="col-md-8 pull-right">
				<div class="form-group">
					...
					<div class="col-md-9">
						{{ Form::text('book_name', '', array('id'=>'book_name', 'class'=>'form-control', 'placeholder'=>'Your series has to have a name.', 'required'=>'')) }}
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						{{ Form::text('publisher_name', '', array('id'=>'publisher_name','class'=>'form-control', 'placeholder'=>'These guys published it. Look at the top left corner.', 'required'=>'')) }}
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						{{ Form::textarea('book_description', '', array('id'=>'book_description','class'=>'form-control', 'placeholder'=>'Give us a summary, get us hooked.')) }}
					</div>
				</div>
			</div>
			<hr style="clear:both">
			...
			<div class="col-md-8 pull-right">
				<div class="form-group">
					...
					<div class="col-md-9">
						{{ Form::text('author_name', '', array('id'=>'author_name', 'class'=>'form-control', 'placeholder'=>'Someone must have written it.','required'=>'')) }}
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						{{ Form::text('artist_name', '', array('id'=>'artist_name','class'=>'form-control', 'placeholder'=>'So, who drew it.','required'=>'')) }}
